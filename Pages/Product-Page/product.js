...
// Fetching data.
const url = "https://tangle-teezer-db.onrender.com/items";
  ...
  try {
    ...
    data.forEach((el) => {
      ...
      productCard.innerHTML = `
        <a href="../description-page/desc.html?id=${el.id}">
...
async function updateCartCount() {
  try {
    const res = await fetch("https://tangle-teezer-db.onrender.com/cart");
  ...
  if (e.target.classList.contains("cart")) {
    ...
    try {
      ...
      const productRes = await fetch(
        `https://tangle-teezer-db.onrender.com/items/${productId}`
      );
      ...
      // Fetch cart
      const cartRes = await fetch("https://tangle-teezer-db.onrender.com/cart");
      ...
      // Add to cart
      await fetch("https://tangle-teezer-db.onrender.com/cart", {
        method: "POST",
...
async function dataShowing() {
  const value = await fetching("https://tangle-teezer-db.onrender.com/signUp");
